...
namespace SpatialPartitionPattern
{
    public class Grid_Vova
    {
        ...
        //Init the grid
        public Grid_Vova(int mapWidth, int cellSize)
        {
            this.cellSize = cellSize;

            int numberOfCells = mapWidth / cellSize;

            cells = new Soldier_Vova[numberOfCells, numberOfCells];
        }


        //Add a unity to the grid
        public void Add(Soldier_Vova soldier)
        {
        ...
        public Soldier_Vova FindClosestEnemy(Soldier_Vova friendlySoldier)
        {
            ...
            Soldier_Vova enemy = cells[cellX, cellZ];

            //Find the closest soldier of all in the linked list
            Soldier_Vova closestSoldier = null;
        ...
        public void Move(Soldier_Vova soldier, Vector3 oldPos)
        {
