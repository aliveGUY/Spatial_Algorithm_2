...
namespace SpatialPartitionPattern {
    public class Grid_Illia
    {
        ...
        //Init the grid
        public Grid_Illia(int mapWidth, int cellSize)
        {
            this.cellSize = cellSize;

            int numberOfCells = mapWidth / cellSize;

            cells = new Soldier_Illia[numberOfCells, numberOfCells];
        }


        //Add a unity to the grid
        public void Add(Soldier_Illia soldier)
        {
        ...
        public Soldier_Illia FindClosestEnemy(Soldier_Illia friendlySoldier)
        {
            ...
            Soldier_Illia enemy = cells[cellX, cellZ];

            //Find the closest soldier of all in the linked list
            Soldier_Illia closestSoldier = null;
        ...
        public void Move(Soldier_Illia soldier, Vector3 oldPos)
        {
